 ...
 * Print the result rounded to two decimal digits after the decimal point. 
 * Use the input and output format from the examples. To hold the points, define a class Point(x, y). 
 * To hold the polygon use a Polygon class which holds a list of points. 
...
using System;
using System.Globalization;                                 // necessary for CultureInfo
using System.Threading;                                     // necessary for Thread
